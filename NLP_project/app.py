...
app.layout = html.Div([
    ...
    html.Div([
        ...
        dcc.Textarea(id="input-message", placeholder="Ask a Question", style={'width': '100%', 'height': '200px'}),
        html.Button("Submit", id="submit-button", n_clicks=0),
        html.Div(id="output-response", style={'margin-top': '20px'}),
        html.Button("Print Required Documents", id="print-docs-button", n_clicks=0, style={'margin-top': '20px'})
